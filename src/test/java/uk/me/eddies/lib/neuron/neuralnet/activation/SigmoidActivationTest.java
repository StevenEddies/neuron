...
public class SigmoidActivationTest {
	...
	public void shouldApproachMaximumForHighInputs(Polarisation eachPolarisation) {
		systemUnderTest = new SigmoidActivation(eachPolarisation);
		assertThat(systemUnderTest.applyAsDouble(1d), closeTo(eachPolarisation.getMaximum(), 0.27 * eachPolarisation.getRange()));
		assertThat(systemUnderTest.applyAsDouble(10d), closeTo(eachPolarisation.getMaximum(), 4.6e-5 * eachPolarisation.getRange()));
		assertThat(systemUnderTest.applyAsDouble(100d), closeTo(eachPolarisation.getMaximum(), 3.8e-44 * eachPolarisation.getRange()));
	...
	public void shouldApproachMinimumForLowInputs(Polarisation eachPolarisation) {
		systemUnderTest = new SigmoidActivation(eachPolarisation);
		assertThat(systemUnderTest.applyAsDouble(-1d), closeTo(eachPolarisation.getMinimum(), 0.27 * eachPolarisation.getRange()));
		assertThat(systemUnderTest.applyAsDouble(-10d), closeTo(eachPolarisation.getMinimum(), 4.6e-5 * eachPolarisation.getRange()));
		assertThat(systemUnderTest.applyAsDouble(-100d), closeTo(eachPolarisation.getMinimum(), 3.8e-44 * eachPolarisation.getRange()));
